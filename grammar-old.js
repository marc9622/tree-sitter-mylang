module.exports = grammar({
    ...
    conflicts: t => [
        ...
        [t.namespace, t.construct_operand],
    ...
    rules: {
        ...
        enum_expr: t => seq(
            'enum', opt(t._param_type_or_id), '{', // the type for tagged enums
            repeat(choice(
        ...
        // let constant : Float { yield 12.3 }
        // let constant : Float | other_value | { yield other_value }
        block_decl: t => seq(
            opt(t.macro),
            choice(
                t._id,
        ...
        func_decl: t => seq(
            choice(
                // ... function ( param: Int , abc: Float ) ...
                // ... function [ Type = Int, value = 10 ] ( ) ...
                seq(
                    field('decl_id', t.value_id),
                    opt('[', separate(t._param_decl, ','), ']'),
                    '(', opt(separate(t._param_decl, ',')), ')',
                ),
                // TODO: Not sure how macros should be declared.
                seq(
                    t.macro,
                    field('decl_id', t.value_id),
                    opt('[', separate(t._param_decl, ','), ']'),
            ...
            seq(
                choice(
                    seq('do', t._expr, ';'),
                    seq(opt(t.capture_block), t.block_expr),
                    ';',
                ),
            ),
        ),
